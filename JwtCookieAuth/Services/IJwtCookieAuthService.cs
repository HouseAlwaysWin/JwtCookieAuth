...
namespace JwtCookieAuth.Services
{
    public interface IJwtCookieAuthService
    {
        ...
        Task<OAuthUserInfoRes> GetOAuthUserInfoAsync(string code, OAuthProviderEnum provider, HttpContext context, string assemblyName = "JwtCookieAuth.Providers.OAuth");
