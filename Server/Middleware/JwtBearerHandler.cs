...
namespace Server.Middleware
{
    ...
    /// <summary>
    /// Generic Jwt Token Handler ,
    /// modified from source code https://github.com/aspnet/Security/blob/master/src/Microsoft.AspNetCore.Authentication.JwtBearer/JwtBearerHandler.cs
    /// </summary>
    /// <typeparam name="TOptions"></typeparam>
    public class JwtBearerHandler<TOptions> : AuthenticationHandler<TOptions> where TOptions : JwtBearerOptions, new()
    {
